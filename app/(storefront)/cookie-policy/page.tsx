  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-16 lg:px-8">
      <div className="mb-10">
        ...
        <h1 className="section-title text-4xl sm:text-5xl">Cookie Policy</h1>
      ...
      <div className="space-y-8 text-sm leading-relaxed text-muted">
        ...
        <div>
          <h2 className="mb-3 font-medium text-foreground">What are cookies?</h2>
        ...
        <div>
          <h2 className="mb-4 font-medium text-foreground">Types of Cookies We Use</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={c.type} className="border-l-2 border-border pl-4">
                <p className="mb-1 font-medium text-foreground">{c.type}</p>
                <p>{c.desc}</p>
              </div>
            ))}
          </div>
        ...
        <div>
          <h2 className="mb-3 font-medium text-foreground">Managing Cookies</h2>
