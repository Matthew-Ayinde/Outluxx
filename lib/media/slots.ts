...
export const MEDIA_SLOTS: MediaSlotDef[] = [
  ...
  {
    id: "category-armless",
    label: "Armless / Tank Tops Category",
    group: "Category Grid",
    allowed: ["image"],
    defaultType: "image",
  ...
  {
    id: "category-tracksuit",
    label: "Tracksuit Category",
    group: "Category Grid",
    allowed: ["image"],
    defaultType: "image",
  ...
  {
    id: "plp-hero-armless",
    label: "Armless / Tank Tops Page Hero",
    group: "Category Page Hero",
    allowed: ["image"],
    defaultType: "image",
  ...
  {
    id: "plp-hero-tracksuit",
    label: "Tracksuit Page Hero",
    group: "Category Page Hero",
    allowed: ["image"],
    defaultType: "image",
  ...
  {
    id: "plp-hero-others",
    label: "Others Page Hero",
    group: "Category Page Hero",
    allowed: ["image"],
    defaultType: "image",
    defaultUrl: "https://picsum.photos/seed/olx-hero-others/1600/600",
  },
  {
